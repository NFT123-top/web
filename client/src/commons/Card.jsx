...
export default function ({ card }) {
  return (
    <div className="p-4 bg-white rounded-xl shadow-lg ">
      <div className="max-w-sm mx-4 flex items-center space-x-4">
        <div className="shrink-0">
          <img className="h-12 w-12" src={card.imgUrl} alt={card.imageAlt}/>
        </div>
        <div>
      ...
      <div className="flex justify-between mx-4 my-2">
        ...
        hover:bg-purple-600 hover:border-transparent 
         ...
         <a href={card.hrefUrl} target="_blank" >
           <button className=" px-4 py-1 mt-2 text-sm text-blue-600 font-semibold rounded-full border border-blue-200
            hover:text-white hover:bg-blue-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2">Enter</button>
         </a>
      </div>
    </div>
    )
