      ...
      <div className="flex items-start justify-between gap-8 pb-8">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-row gap-2">
            <a href="https://twitter.com/TiThinker" target="_blank" ><FaTwitter fontSize={20} className="" onClick={(1===1)}/></a>
            <a href="https://twitter.com/TiThinker" target="_blank" ><FaDiscord fontSize={20} className="" onClick={(1===1)}/></a>
